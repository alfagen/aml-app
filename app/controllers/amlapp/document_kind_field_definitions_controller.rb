module Amlapp
  class DocumentKindFieldDefinitionsController < Amlapp::ApplicationController
    ...
    def new
      render :new, locals: { document_kind_field_definition: AML::DocumentKindFieldDefinition.new(permitted_params), document_kind: document_kind }
    end
    ...
    def permitted_params
      params.fetch(:document_kind_field_definition, {}).permit(:key, :title, :document_kind_id, :position)
    end
  end
end
